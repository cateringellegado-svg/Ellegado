...
-- 7. Migración eventos completa
ALTER TABLE eventos ADD COLUMN IF NOT EXISTS nombre TEXT DEFAULT '';
ALTER TABLE eventos ADD COLUMN IF NOT EXISTS fecha DATE;
ALTER TABLE eventos ADD COLUMN IF NOT EXISTS tipo TEXT DEFAULT '';
ALTER TABLE eventos ADD COLUMN IF NOT EXISTS cliente TEXT DEFAULT '';
ALTER TABLE eventos ADD COLUMN IF NOT EXISTS invitados INTEGER DEFAULT 0;
ALTER TABLE eventos ADD COLUMN IF NOT EXISTS menu TEXT DEFAULT '';
ALTER TABLE eventos ADD COLUMN IF NOT EXISTS notas TEXT DEFAULT '';
