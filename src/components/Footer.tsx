      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12 items-start text-slate-600 text-sm">
        <div className="text-left space-y-3">
          ...
          <p className="flex items-center gap-2">
            <svg className="w-4 h-4 text-brand-copper shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex gap-4">
            {config.social.instagram.active && config.social.instagram.url && (
              <a href={config.social.instagram.url} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-brand-copper/10 text-brand-copper flex items-center justify-center hover:bg-brand-copper hover:text-white transition-colors" aria-label="Seguinos en Instagram">
            ...
            {config.social.facebook.active && config.social.facebook.url && (
              <a href={config.social.facebook.url} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-brand-copper/10 text-brand-copper flex items-center justify-center hover:bg-brand-copper hover:text-white transition-colors" aria-label="Seguinos en Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
