...
export default function Footer() {
  return (
    <footer className="py-20 bg-cream text-center border-t border-brand-copper/10 px-6">
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12 items-center text-slate-600 text-sm">
        <div className="text-left space-y-2">
          ...
          <p className="flex items-center gap-2">
            <svg
              className="w-4 h-4 text-brand-copper shrink-0"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <a
              href="mailto:catering.ellegado@gmail.com"
              className="hover:text-brand-copper transition-colors"
            >
              catering.ellegado@gmail.com
            </a>
          </p>
          <p className="flex items-center gap-2">
            <svg
            ...
            <span>+54 11 7675 3854</span>
          </p>
          <p className="flex items-center gap-2 pt-2 border-t border-brand-copper/10">
            <svg
              className="w-4 h-4 text-brand-copper shrink-0"
              fill="none"
              stroke="currentColor"
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="italic mb-6 text-slate-600">
            Haz Eterno Cada Momento
          </p>
          <div className="flex gap-4">
            <a
              href="https://instagram.com/ellegado.catering"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-brand-copper/10 text-brand-copper flex items-center justify-center hover:bg-brand-copper hover:text-white transition-colors"
            ...
            <a
              href="https://facebook.com/ellegado.catering"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-brand-copper/10 text-brand-copper flex items-center justify-center hover:bg-brand-copper hover:text-white transition-colors"
        ...
        <div className="text-right flex flex-col items-end space-y-2">
          <p className="font-bold text-brand-copper mb-2 uppercase tracking-widest text-xs">
            Legales
          </p>
          <Link
            href="/aviso-legal"
